...
const CouriersAccepted = () => {
	...
	const [courierRowsList, setCourierRowsList] = useState(getRowsList(state.courier.couriers.Accepted))

	useEffect(() => {
		setCourierRowsList(getRowsList(state.courier.couriers.Accepted))
	}, [state])
...
export default CouriersAccepted
