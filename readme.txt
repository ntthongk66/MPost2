...
1. Sinh viên thực hiện - nhóm 8

 Nguyễn Tiến Thông - 21020408:    Nhóm trưởng + BE
 Phan Mạnh Thắng - 21020405  :    FE + thiết kế giao diện
 Đỗ Đức Huy - 21020124       :    FE + thiết kế giao diện
...
4.2 Phía Backend
4.2.1 Cài dependencies:
    npm install

4.2.2 Tạo tệp .env và cung cấp các giá trị cấu hình cần thiết: DATABASE_URI, JWT_SECRET, JWT_REFRESH_SECRET, NODEMAILER_EMAIL và ODEMAILER_PASS.
...
4.3 Phía Frontend
4.3.1 Cài dependencies:
    npm install
	
4.3.2 Thay đổi apiHost trong apiLoc.js (http://localhost:4545 cho máy cục bộ)
